		...
		<div class="main">
           <form action="" name="eForm">
	               ...
	               <div class="modal-content">
	                 ...
	                 <script>
	                   $(function(){
                     	...
                     	function approve(){
	                	   alertify.confirm('승인하시겠습니까?', function(){ $("form[name=eForm]").attr("action","approve.ap").submit();}
	                       ); 
	                   }
	                   
	                   function returnAppr(){
	                	   alertify.confirm('반려하시겠습니까?', function(){ $("form[name=eForm]").attr("action","return.ap").submit();}
	                       );
	                   }
             ...
             <div class="app-form1">
	         	...
	         	<input type="hidden" name="apprDocType" value="${exp.apprDocType}">
               <br>
                ...
                <c:choose>
                 ...
                 <script>
                	$(function(){
                		...
                		let value2 = $("#tb2").children().children().eq(2).children().eq(0).text();
                		if(!value2){
                			$("#tb2").children().children().eq(1).children().eq(0).append("<input type='hidden' name='apprLevel' value='1'>");
                		}else{
                			$("#tb2").children().children().eq(1).children().eq(0).append("<input type='hidden' name='apprLevel' value='2'>");
                			$("#tb2").children().children().eq(1).children().eq(0).prepend('<img src="resources/approval_images/stamp_approved.png" width="35" height="40"><br>');
                		}
                	})
                </script>
	                 ...
	                 <div class="reModal-body">
		                 ...
		                 <form action="" name="reason">
		                     ...
		                     <span style="margin-left:10px;">
		                     	<c:choose>
		                     		<c:when test="${ exp.apprDocType eq 1 }">
		                     			휴가신청
		                     		</c:when>
		                     		<c:when test="${ exp.apprDocType eq 2 }">
		                     			연장근무신청
		                     		</c:when>
		                     		<c:otherwise>
		                     			지출결의서
